...
if((v_docn == "/")||(v_docn.indexOf("/index") != -1)||(v_docn.indexOf("/default") != -1)){v_docn = "/index"};
v_path = v_path.slice(0,v_path.lastIndexOf("/"));

OAS_url = 'http://mjxads.internet.com/RealMedia/ads/';
OAS_sitepage = 'intm/webdev/www.xmlfiles.com' + v_path + v_docn;
OAS_listpos = '468x60-1,468x60-2,marketplace01,marketplace02,marketplace03,marketplace04,marketplace05,marketplace06,marketplace07,marketplace08,marketplace09,marketplace10,cp1,cp2,cp3,cp4,cp5,cp6,cp7,cp8,cp9,cp10,cp11,cp12,cp13,cp14,house_ribbon,flex,ciu';
OAS_query = '';
OAS_target = '_top';
OAS_version = 10;
